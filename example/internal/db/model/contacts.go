...
var ContactWhere = struct {
	...
	ID:        whereHelpernull_Int64{field: "\"contacts\".\"id\""},
	...
	CreatedAt: whereHelpertime_Time{field: "\"contacts\".\"created_at\""},
	UpdatedAt: whereHelpertime_Time{field: "\"contacts\".\"updated_at\""},
}
...
var (
	contactAllColumns            = []string{"id", "email", "name", "phone", "created_at", "updated_at"}
	contactColumnsWithoutDefault = []string{"email", "name"}
	contactColumnsWithDefault    = []string{"id", "phone", "created_at", "updated_at"}
	contactPrimaryKeyColumns     = []string{"id"}
	contactGeneratedColumns      = []string{"id"}
)
...
func (q contactQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Contact, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: failed to execute a one query for contacts")
	}
...
func (q contactQuery) All(ctx context.Context, exec boil.ContextExecutor) (ContactSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "model: failed to assign all query results to Contact slice")
	}
...
func (q contactQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to count contacts rows")
	}
...
func (q contactQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "model: failed to check if contacts exists")
	}
...
func FindContact(ctx context.Context, exec boil.ContextExecutor, iD null.Int64, selectCols ...string) (*Contact, error) {
	contactObj := &Contact{}
	...
	query := fmt.Sprintf(
		"select %s from \"contacts\" where \"id\"=?", sel,
	)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "model: unable to select from contacts")
	}
...
func (o *Contact) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("model: no contacts provided for insertion")
	}
	...
	if !cached {
		...
		wl = strmangle.SetComplement(wl, contactGeneratedColumns)
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to insert into contacts")
	}
...
func (o *Contact) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("model: unable to update contacts, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update contacts row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by update for contacts")
	}
...
func (q contactQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all for contacts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected for contacts")
	}
...
func (o ContactSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to update all in contact slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to retrieve rows affected all in update all contact")
	}
	return rowsAff, nil
}
...
func (o *Contact) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("model: no contacts provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("model: unable to upsert contacts, could not build update column list")
		}
		...
		cache.query = buildUpsertQuerySQLite(dialect, "\"contacts\"", updateOnConflict, ret, update, conflict, insert)
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to upsert contacts")
	}
...
func (o *Contact) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("model: no Contact provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete from contacts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by delete for contacts")
	}
...
func (q contactQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("model: no contactQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from contacts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "model: failed to get rows affected by deleteall for contacts")
	}
...
func (o ContactSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "model: unable to delete all from contact slice")
	}
...
func (o *ContactSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "model: unable to reload all in ContactSlice")
	}
...
func ContactExists(ctx context.Context, exec boil.ContextExecutor, iD null.Int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"contacts\" where \"id\"=? limit 1)"
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "model: unable to check if contacts exists")
	}
